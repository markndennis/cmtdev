...
class Admin extends CI_Controller {
    ...
    function createuser() {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $this->usermodel->createuser($pin, $susername, $email);
            
            // email user info
            $message="<html><meta http-equiv='Content-Type' content='text/html; charset=UTF-8'>Thank you for signing up for an exam.  You will need a PIN in order to log in.<br><br>Your PIN is <strong>" . $pin . "</strong> .<br><br>                
You can log into your exam at http://www.exam.cmtbc.ca/ .<br><br>
...
The CMTBC serves and protects the public by regulating the profession of massage therapy in B.C. in accordance with the Health Professions Act. We believe in personal integrity, administrative fairness and professional accountability.</small></html>";
            $this->mailer->email_send($email,"Your CMTBC Jurisprudence Exam PIN for " . $username,$message);
...
/*
    ...
    */
    ...
    function testemail() {
        $email = "markndennis@hotmail.com";
        $message="<html><meta http-equiv='Content-Type' content='text/html; charset=UTF-8'>This is a test of the email server</html>";
        $this->mailer->email_send($email,"Email Server Test",$message);
        echo "email to " . $email . " sent";
    }
